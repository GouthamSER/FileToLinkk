...
from brain.bot import StreamBot
from brain.bot.clients import cleanup_clients, initialize_clients
from brain.server import web_server
from brain.utils.commands import set_commands
from brain.utils.database import db
from brain.utils.keepalive import ping_server
from brain.utils.logger import logger
from brain.utils.messages import MSG_ADMIN_RESTART_DONE
from brain.utils.rate_limiter import rate_limiter, request_executor
from brain.utils.tokens import cleanup_expired_tokens
from brain.vars import Var


PLUGIN_PATH = "brain/bot/plugins/*.py"
VERSION = __version__
...
async def import_plugins():
    ...
    for file_path in plugins:
        try:
            ...
            import_path = f"brain.bot.plugins.{plugin_name}"
