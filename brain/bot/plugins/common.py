...
from brain.utils.bot_utils import (gen_dc_txt, get_user, log_newusr,
                                     reply_user_err)
from brain.utils.database import db
from brain.utils.decorators import check_banned
from brain.utils.file_properties import get_fname, get_fsize, parse_fid
from brain.utils.force_channel import force_channel_check, get_force_info
...
async def start_command(bot: Client, msg: Message):
    ...
    btns = [
        ...
        [InlineKeyboardButton(MSG_BUTTON_GITHUB, url="https://github.com/GouthamSER/FileToLinkk"),
